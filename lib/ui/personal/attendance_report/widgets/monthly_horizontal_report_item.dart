...
class MonthlyHorizontalReportItem extends StatelessWidget {
  final AttendanceReportSummary report;
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            Text(report.totalOffDays.toString()),
          ],
        ),
        const Divider(),
        Row(
          ...
          children: [
            ...
            Text(report.totalWorkingDays.toString()),
          ],
        ),
        const Divider(),
        Row(
          ...
          children: [
            ...
            Text(report.totalPresentDays.toString()),
          ],
        ),
        const Divider(),
        Row(
          ...
          children: [
            ...
            Text(report.totalAbsentDays.toString()),
          ],
        ),
        const Divider(),
        Row(
          ...
          children: [
            ...
            Text(report.totalLeaveDays.toString()),
          ],
        ),
        const Divider(),
        Row(
          ...
          children: [
            ...
            Text(report.totalWorkingHours.toString())
          ],
        )
      ],
    );
